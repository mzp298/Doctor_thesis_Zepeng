...
data in \figref{fig.sizeeffect}(a) is much higher than the one for the (fatigue limit-L) data in \figref{fig.sizeeffect}(b).
...
\graphfile*[45]{figures//carbonsteel.png}[]
\graphfile*[45]{figures//1220steel.png}[]
\\
\graphfile*[45]{figures//1035steel.png}[]
\graphfile*[45]{figures//40khsteel.png}[]
\end{Figure}

\figref{fig.gradientcalibration} shows some test results of rotating bending fatigue limits
from the literature in which the fatigue limits are plotted against
the specimen radii. \figref{fig.gradientcalibration}(a,b,c) are related to cantilever bending
tests and \figref{fig.gradientcalibration}(d) depicts constant moment tests.
